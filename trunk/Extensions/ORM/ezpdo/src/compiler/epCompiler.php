...
/**
 * $Id: epCompiler.php,v 1.19 2005/12/11 18:25:40 nauhygon Exp $
 * 
 * Copyright(c) 2005 by Oak Nauhygon. All rights reserved.
 * 
 * @author Oak Nauhygon <ezpdo4php@gmail.com>
 * @version $Revision: 1.19 $ $Date: 2005/12/11 18:25:40 $
 * @package ezpdo
...
/**
 * The exception class for {@link epCompiler}
 * 
 * @author Oak Nauhygon <ezpdo4php@gmail.com>
 * @version $Revision: 1.19 $ $Date: 2005/12/11 18:25:40 $
 * @package ezpdo
 ...
 * @subpackage ezpdo.compiler
 */
class epCompiler extends epConfigurableWithLog {
    ...
    protected function getOnlySourceFiles($input_files) { 
        ...
        foreach($input_files as $input_file) {
            if (preg_match($pattern, $input_file)) {
                ...
                if ($this->getConfigOption('warn_non_source_files')) {
    ...
    /**
     * Carry out one of the compile tasks (see {@link epCompiler::compile()}). 
    ...
    protected function parseFile($file) {
        ...
        if (!$this->parser) {
            ...
            $this->parser = new epParser($this->getConfig());
        }
