...
/**
 * $Id: epQueryParser.php,v 1.13 2005/12/14 14:14:16 nauhygon Exp $
 * 
 ...
 * @subpackage ezpdo.query
 */
class epQueryParser extends epBase {
    ...
    protected function variable() {
        ...
        do {
            ...
            if ($t == EPQ_T_IDENTIFIER) {
                ...
                $part->setParam('val', $this->t->value);
            } else if ($t == '?') {
                $this->next();
    ...
    protected function error($msg = '') {
        ...
        if ($this->t) {
            $this->_error = new epQueryError($msg, $this->t->value, $this->t->line, $this->t->char);
        } else {
            $this->_error = new epQueryError($msg, '', 0, 0);
        }
     ...
     * If no or null argument, return the current verbose mode
     * @return boolean
     */
